...
​     2.为什么网页还没加载出来程序就退出了? 
​				---可能是网速太慢，程序设计了超时关闭功能(大概80秒左右吧)

​     3.为什么播放时/切换下一集/无缘无故就程序报错了?
​				---程序所使用的Selenium库总是抽风,导致小概率出错的情况,作者已经尽全力调整,
​				每个参数都设为了最佳状态,但无法做到完全杜绝,猜测是Selenium库本身设计缺陷

**已知问题:**

- 由于Selenium不稳定,所以使用了大量try语句,有更好解决方案的大佬可以提交你的代码~
