...
2.请使用 Python 3.10、3.11 或 3.12，其他 Python 版本将被程序拒绝。

3.文件夹内有 **configs.ini文件** (可能没显示 **.ini**后缀名)，请用文本编辑器打开;
